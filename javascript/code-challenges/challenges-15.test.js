...
let biggerThanLuke = (arr) => {
  // Solution code here...
  return arr.filter(character => parseInt(character.mass) > parseInt(arr[0].mass)).map(character => character.name).join(' - ');
};
